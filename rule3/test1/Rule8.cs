        ...
        public void checkCandleResult_v1()
        {
               ...
               (currentCandle == 17))
            {
                ...
                if (checkLostChainTotal == 5)
                {
                    ...
                    chromeDriver.ExecuteScript("var popupwin = window.open('https://api.telegram.org/bot1477417480:AAHtpkU2nrwMiTC_zl-rThkFTLEOE2xbEEA/sendMessage?chat_id=-1001398145297' + '&text=[BOT_INFO]  PP bắt chéo hàng 1 nghịch  :    %0A  Đã có 5 chuỗi thua liên tục!   ', 'anyname', 'width=10,height=1,left=5,top=3'); setTimeout(function () {     popupwin.close(); }, 1000);;");
                }
            }
        }

...
namespace WeFinex
{
    ...
    public class Rule8
    {
        ...
        public void ruleLogic()
        {
            ...
            checkCandle1_v1();
            checkCandleCommand_v1();
            checkCandleResult_v1();
        }


        public void checkCandle1_v1()
        {
            // 1 = blue
            // 0 = red
            ...
            {
                int colorCheck = 0;
                int colorCommand = checkColorCandle1_v1();
                ...
                if (checkLostChainTotal == 5)
                {
                    //  checkLostChainTotal = 4;

                    chromeDriver.ExecuteScript("var popupwin = window.open('https://api.telegram.org/bot1477417480:AAHtpkU2nrwMiTC_zl-rThkFTLEOE2xbEEA/sendMessage?chat_id=-1001398145297' + '&text=[BOT_INFO]  PP Bat cheo hang 1 thuận :    %0A  Đã có 5 chuỗi thua liên tục!   ', 'anyname', 'width=10,height=1,left=5,top=3'); setTimeout(function () {     popupwin.close(); }, 1000);;");
                }
            }

        }

        public void checkCandleCommand_v1()
        {
            if ((currentCandle == 3) ||
                (currentCandle == 7) ||
                (currentCandle == 11) ||
                ...
                (currentCandle == 19))
            {
                int colorCommand = checkColorCandleBlock0_v1(currentCandle);
        ...
        public void checkCandleResult_v1()
        {
            if ((currentCandle == 5) ||
                (currentCandle == 9) ||
               (currentCandle == 13) ||
            ...
            {
                int colorCheck;
                int colorCommand = checkColorCandleBlock0_v1(currentCandle - 2);
                ...
                if (checkLostChainTotal == 5)
                {
                    ...
                    chromeDriver.ExecuteScript("var popupwin = window.open('https://api.telegram.org/bot1477417480:AAHtpkU2nrwMiTC_zl-rThkFTLEOE2xbEEA/sendMessage?chat_id=-1001398145297' + '&text=[BOT_INFO]  PP bắt chéo hàng 1 thuận  :    %0A  Đã có 5 chuỗi thua liên tục!   ', 'anyname', 'width=10,height=1,left=5,top=3'); setTimeout(function () {     popupwin.close(); }, 1000);;");
                }
            }
        }

        public int checkColorCandle1_v1()
        {
            // 1 = blue
            // 0 = red
            ...
            if (block1[checkCandle].CompareTo("blue") == 0)
            {
                columResult = 1;
            }
            else
        ...
        public int checkColorCandleBlock0_v1(int candle)
        {
            // 1 = blue
            // 0 = red

            int checkCandle = candle - 1;
            int columResult = 2;

            if (block0[checkCandle].CompareTo("blue") == 0)
            {
                columResult = 1;
            }
            else
